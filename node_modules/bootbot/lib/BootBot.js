    ...
    data.entry.forEach((entry) => {
      ...
      entry.messaging.forEach((event) => {
        ...
        if (event.optin) {
          ...
          for (var key in this._conversations) {
            if (this._conversations.hasOwnProperty(key) && this._conversations[key].userId==event.sender.id) {
              this._conversations.splice(key,1);
                  }
              }
